...
import {
    ...
    Tag, message, Card, Typography, Timeline, Input
} from 'antd';
import {
...
import TimelineInfo from '../homePage/TimelineInfo';
                ...
                <section>
                    ...
                    <div>
                        ...
                        <Card style={{
                            ...
                            <Timeline style={{ marginBottom: '20px', paddingLeft: '7px', overflow: 'auto', width: '100%', height: '300px' }}>
                                {/* 이번주 이벤트 */}
