...
import { List, Button, Input,Table,Layout } from 'antd';
...
const Setting_page = () => {
    ...
    //           for(let j in count){
    //               if (categoryList[i].category === count[j].category){
    //                   //categoryList[i].concat(count[j].count);
    //               }
    //           }
    //       }
